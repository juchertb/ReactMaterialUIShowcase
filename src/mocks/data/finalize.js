...
export default function (db) {
  ...
  // set customer name
  db.customerOrders.forEach((customerOrder) => {
    const customerName =
      db.customers[customerOrder.customer_id].first_name +
      " " +
      db.customers[customerOrder.customer_id].last_name;
    customerOrder.name = customerName;

    customerOrder.email = db.customers[customerOrder.customer_id].email;
    customerOrder.joinDate = db.customers[customerOrder.customer_id].first_seen;
  });

  // set customer name
  // db.customers.forEach((customer) => {
  //   customer.name = customer.first_name + " " + customer.last_name;
  //   customer.joinDate = customer.first_seen;
  // });
