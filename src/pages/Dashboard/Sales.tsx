        ...
        {isAuthenticated === true ? (
          <>
            <Grid2 container spacing={2}>
              ...
              <FormGrid size={{ sm: 12, md: 4 }} sx={{ border: 1, height: 300 }} >
                <Paper elevation={3} sx={{ borderRadius: "0.75rem", width: "100%", height: "100%", padding: "15px", marginTop: "15px" }}>
                  <Channels />
                </Paper>
              </FormGrid>
              <FormGrid size={{ sm: 12, md: 8 }} sx={{ border: 1 }}>
                <Paper elevation={3} sx={{ borderRadius: "0.75rem", width: "100%", height: "100%", padding: "15px", marginTop: "15px" }}>
                  <RevenueLineChart />
                </Paper>
              </FormGrid>

              <FormGrid size={{ sm: 12, md: 8 }} sx={{ border: 1, height: 300 }} >
                <Paper elevation={3} sx={{ borderRadius: "0.75rem", width: "100%", height: "100%", padding: "15px", marginTop: "15px" }}>
                  <SalesByAgeBarChart />
                </Paper>
              </FormGrid>
              <FormGrid size={{ sm: 12, md: 4 }} sx={{ border: 1 }}>
                <Paper elevation={3} sx={{ borderRadius: "0.75rem", width: "100%", height: "100%", padding: "15px", marginTop: "15px" }}>
                  <SalesByCountry />
                </Paper>
              </FormGrid>
